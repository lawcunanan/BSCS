			...
			<div class="main-content">
				<header class="topbar">
					...
					<div class="topbar-middle">
						<b>MANAGE CLASS LIST: GRADE <?php echo $grade ?> - <?php echo $section ?> (S.Y. <?php echo $school_year ?>) </b>
					</div>
				</header>
					...
					<div class="card">
						<form method="POST" class="search-form">
							<div class="search-container">
								...
								<input type="text" id="search-input" class="search-input" placeholder="Search by LRN or Name" name="filterSearch_me" />
