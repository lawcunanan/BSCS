...
<body>
    <div class="dashboard">
        <?php $cur = 'generate'; include_once "../../../controller/registrar/sidebar.php"; ?>
            ...
            <main class="dashboard-content">
                <div class="card">
                    ...
                    <div class="preview-location">
                        <button type="button" id="print-button" class="btn btn-secondary print" data-bs-toggle="modal" data-bs-target="#printModal">
                            <i class="fa fa-print"></i> Release Document
                        </button>
                        <div class="main">
                            <?php 
                                if($_POST['docuType'] !== "3"){
