<?php require "../../../controller/registrar/main.php";
...
<html lang="en">
	...
	<body>
		<div class="dashboard">
			<?php $cur = 'index'; include_once "../../../controller/registrar/sidebar.php"; ?>
			<div class="main-content">
				<header class="topbar">
					...
					<div class="topbar-right">
						<div class="user-info">
							<span>Welcome, Registrar <?php echo username(); ?></span>
							<div class="user-avatar">
								<img
									src="../../../model/picture/User_<?php echo $registrar?>.png?"
									alt=""
