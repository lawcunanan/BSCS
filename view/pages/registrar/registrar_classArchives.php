...
<body>
    <div class="dashboard">
        <?php $cur = 'archives'; include_once "../../../controller/registrar/sidebar.php"; ?>
                ...
                <div class="card">
                    <form method="POST" class="search-form">
                        <div class="search-container">
                            ...
                            <select class="form-select" id="filterYear" name="filterYear_ca">
                                <option disabled hidden selected value="">Select School Year</option>
                                <?php echo schoolyear(); ?>
                            </select>
                        </div>
                        <div class="search-container">
                            <label for="filterGrade" class="form-label">Filter by Grade Level:</label>
                            <select class="form-select" id="filterGrade" name="filterGrade_ca">
                                <option disabled hidden selected value="">Select Grade Level</option>
                                <?php echo gradelevel(); ?>
                            </select>
                        </div>
                        <div class="button-container">
                            <button type="button" id="search-button" class="btn btn-secondary" name="btnfilter_ac">Filter</button>
                            <button type="button" id="reset-button" class="btn btn-outline-secondary">Reset</button>
                        </div>
                    </form>
                    <hr>
                    <h2>CLASSES HISTORY</h2>
