...
<html lang="en">
	...
	<body>
		<div class="dashboard">
		    <?php $cur = 'calendar'; include_once "../../../controller/registrar/sidebar.php"; ?>
			<div class="main-content">
				<header class="topbar">
					<button class="menu-toggle"><i class="fas fa-bars"></i></button>
					<div>
						<b>CALENDAR OF ACTIVITIES</b>
						<button class="btn btn-primary" style="margin-left: 20px" data-bs-toggle="modal" data-bs-target="#addEventModal">
